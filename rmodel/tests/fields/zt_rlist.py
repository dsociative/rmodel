...
class RListTest(BaseTest):
    ...
    def test_typing(self):
        ...
        self.eq(self.model.names.data(), [123, 42])

    def test_remove(self):
        self.model.names.append('hello', 'test')
        self.model.names.remove('hello')
        self.eq(self.model.names.data(), ['test'])
    ...
    def test_trim(self):
        ...
        self.eq(self.field.data(), list(xrange(1, 10)))
        self.field.trim(0, 0)
        self.eq(self.field.data(), [1])
